...
# # NOTE: explicit key added to avoid DuplicateElementId errors
# if st.session_state.last_user and st.button("🔁 Regenerate response", type="secondary", key="regenerate_btn"):
